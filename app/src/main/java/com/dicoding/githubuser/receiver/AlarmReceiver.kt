...
class AlarmReceiver : BroadcastReceiver() {
    ...
    private fun showAlarmNotification(
        ...
        val notifIntent =
            context.packageManager.getLaunchIntentForPackage("com.dicoding.githubuser")
    ...
    fun setRepeatingAlarm(context: Context, time: String, message: String) {
        ...
        Toast.makeText(context, context.resources.getString(R.string.alarmSet), Toast.LENGTH_SHORT)
            .show()
    }
    ...
    fun cancelAlarm(context: Context) {
        ...
        Toast.makeText(
            context,
            context.resources.getString(R.string.alarmCancelled),
            Toast.LENGTH_SHORT
        ).show()
    }
